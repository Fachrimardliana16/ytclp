...
router.get('/plans', (req, res) => {
  res.json({
    plans: [
      { id: 'free', name: 'Free', price: 0, credits: 10, features: ['10 clip/bulan', 'Watermark 10%', '720p output', 'Basic templates'] },
      { id: 'pro', name: 'Pro', price: 99000, credits: 100, features: ['100 clip/bulan', 'Tanpa watermark', '1080p output', 'Semua templates', 'Custom captions', 'Priority support'] },
      { id: 'business', name: 'Business', price: 299000, credits: 500, features: ['500 clip/bulan', 'Semua fitur Pro', '4K output', 'API access', 'Batch export', 'Team management'] },
    ],
